...
print(authors[0],':',information['김시습'])
print(authors[1],':',information['허균'])
print(authors[2],':',information['남영로'])
print(authors[3],':',information['작자 미상'])
print(authors[4],':',information['임제'])